...
public class SelectLevelController : MonoBehaviour 
{
    ...
    public void buttonSelect()
    {
        ...
        gameManager.instance.arena.setAreaValues(activeDifficult[activeLevel]);
        gameManager.instance.arena.setActive(true);
        gameManager.instance.endGamePanel.setActive(false);
    ...
    public void buttonDebugSelectArenaFilled()
    {
        ...
        gameManager.instance.randomGame = false;
        gameManager.instance.arena.resetAreaValues();
        gameManager.instance.arena.setAreaValuesDEBUG(activeDifficult[activeLevel]);
        gameManager.instance.arena.setActive(true);
        gameManager.instance.endGamePanel.setActive(false);
        gameManager.instance.numpad.hide();
        MainMenuManager.mainMenu.setActive(false);
