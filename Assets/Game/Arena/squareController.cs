...
public class squareController : MonoBehaviour
{
    ...
    public void Init()
    {
        ...
        {
            for (int x = 0; x < 3; ++x, ++i) area[x, y] = gameObject.transform.GetChild(i).gameObject.GetComponent<areaController>();
        }
    }

    public areaController getArea(int ID)
    {
        return gameObject.transform.GetChild(ID).gameObject.GetComponent<areaController>();
    }
